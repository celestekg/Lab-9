//Celeste Going
//Lab 9
/*This program generates 25 random numbers in an array.
It then finds and prints both the highest and lowest values
in the array and their positions, and also finds and
prints the average of the values in the array.
The program also prints a table that displays the
position of the value, the value, and the difference
between the value and the average.*/
